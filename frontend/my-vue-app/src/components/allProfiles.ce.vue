<template>
    <div class="d-flex flex-column align-items-start col-8 mx-auto border border-dark rounded shadow bg-white" v-bind="$attrs">    
                ...
                <div class="w-50 mx-auto mb-3"><img class="mw-100" :src="$attrs.avatarUrl" alt="avatar"/></div>
    </div>            
    <div class="d-flex flex-column col-8 mx-auto border border-dark rounded shadow mt-1 mb-3">
            <form id="form" class="mt-5" enctype="multipart/form-data" @submit.prevent="adminModifyAvatar($attrs.id)">
